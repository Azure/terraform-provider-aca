...
| [express_mode](express_mode/) | ⭐ Beginner | Fully serverless ACA Express environment via AzAPI overlay | RG, Express Environment, 1 App |
| [sandbox_groups](sandbox_groups/) | ⭐⭐⭐ Advanced | ACA Sandbox Groups (new ARM resource) via AzAPI, with delegated subnet + VNet connection | RG, VNet, Subnet, Sandbox Group, VNet Connection |
...
- [Express Mode](express_mode/) — Fully serverless ACA Express environment via AzAPI overlay
- [Sandbox Groups](sandbox_groups/) — ACA Sandboxes (new ARM resource) with VNet integration via AzAPI
